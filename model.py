...
#-------------------------------------------------------
# KNN
def knn(X_train, y_train, X_validate, y_validate, max_k = 25):
    '''
...
def model_report():
    ...
    report1 = {
        'Model': ['DT', 'RF', 'KNN'],
        'Parameters' : ['Max Depth = 3', 'Max Depth = 6 & Min Sample Leaf = 2', 'KNN = 19'],
        'Train' : [0.792, 0.818, 0.796],
        'Validate' : [0.794, 0.808, 0.789]
    } 
...
# Prediction on Test
def best_churn_prediction(X_train, y_train, y, X):
